...
module.exports = function(req, res, js){
  ...
  var register_username = <div><input type="text"></input>;
  ...
  var footer_left = <ul><li>Register:</li><li>{register_username}</li><li>{register_password}</li></ul>;
  var footer_right = <ul><li>Login:</li><li>{login_username}</li><li>{login_password}</li><li>{login_message}</li></ul>;
  var footer = <div id="footer"><div class="left">{footer_left}</div><div class="right">{footer_right}</div></div>;

  var body = <div>{header}{feed} {footer}</div>;
  js.dom(body);
